...
export const BurgerIngredient = ({ item, modal, id }) => {
  const { counts, bun } = useSelector(store => store.items.burgerIngredients);
  ...
  return (
    <li className={styles.card} onClick={() => modal(item)} ref={drag} >
